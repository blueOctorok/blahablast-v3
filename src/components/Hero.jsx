      ...
      >
        <div className="max-w-screen-xl flex justify-between items-center w-full px-4 md:px-8 lg:px-16">
          <div className="ml-auto mr-0 md:mr-auto">
            ...
            <button
              onClick={openModal}
              className="mt-6 px-4 py-2 text-sm font-medium text-custom-dark-blue bg-white bg-opacity-80 border border-custom-dark-blue rounded-lg hover:bg-opacity-100 hover:shadow-md transition-all duration-300 backdrop-blur-sm"
            >
              Site Details
            </button>
          </div>
